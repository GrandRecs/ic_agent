...
path = args.path or "./models/"
model = args.model or "neural-chat-7b-v3-1"
embedding = args.embedding or "bge-base-en-v1.5"
...
print("Loading language model from " + model_id)
...
if os.path.exists(path+embedding):
    model_name = path+embedding
else:
    model_name="BAAI/bge-base-en-v1.5"

print("Loading embeding model from " + model_name)

embedding = HuggingFaceInstructEmbeddings(model_name=path+model_name, model_kwargs={"device": "cuda"})
