...
class PromptCompressor:
    def __init__(self, model, tokenizer, config):
        self.load_model(model, tokenizer, config)
        self.retrieval_model = None
        self.retrieval_model_name = None
        self.open_api_config = None
        self.cache_bos_num = 10
        self.prefix_bos_num = 100

    def load_model(self, model, tokenizer, config):
        self.device = "cuda"
#         (
...
#         )
    ...
    def compress_prompt(
        ...
        compressed_tokens = len(self.tokenizer.tokenize(compressed_prompt))
        return {
